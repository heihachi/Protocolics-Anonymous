...
int main(int argc, char *argv[])
{
    ...
    // Set up config
//    Settings settings;
//    char const* configFile = _PA_CONFIG;

//    if (!sConfigMgr->LoadInitial(configFile))
//    {
//        printf("Invalid or missing configuration file : %s\n", configFile);
//        printf("Verify that the file exists and has \'[Protocolics-Anonymous]\' written in the top of the file!\n");
//        return 1;
//    }

    // Prepare Clients data and connect
//    settings.host = sConfigMgr->GetStringDefault("Server", "");
//    settings.port = sConfigMgr->GetIntDefault("Port", 12345);
...
//    server.start();
    ...
    //Curses gui;
    printf("Protocolics Anonymous has been closed.");
    return 0;
}
